"""Build hermes_exp04_colab.ipynb from nb_src.py.

nb_src.py is the source of truth, written in "percent" format:
...
Edit nb_src.py (or one of the embedded files), then run:  python build_notebook.py
"""
import json
import pathlib
...
SRC = HERE / "nb_src.py"
OUT = HERE / "hermes_exp04_colab.ipynb"
...
def file_cell(name):
    ...
    return [
        f"# {name} is copied verbatim from experiments/04-dreamerv3-baseline/{name}",
